...
- Pkg folder: [packages\rbac-repo-snapshots](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-repo-snapshots)
...
graph LR
  ...
  rbac_repo_snapshots["rbac_repo_snapshots"]:::center
  rbac_repo_snapshots -->|FK| rbac_repositories["rbac_repositories"]:::link
...
- `taken_at` – default=CURRENT_TIMESTAMP(6)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-repo-snapshots -Apply
