...
| Pkg folder | [packages\rbac-repo-snapshots](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-repo-snapshots) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-repo-snapshots -Apply
