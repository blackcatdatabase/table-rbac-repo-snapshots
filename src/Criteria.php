...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'repo_id', 'commit_id', 'taken_at', 'metadata' ];
    }
...
{
    return [ 'id', 'repo_id', 'commit_id', 'taken_at' ];
}
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RbacRepoSnapshots\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RbacRepoSnapshots\Definitions::softDeleteColumn();
