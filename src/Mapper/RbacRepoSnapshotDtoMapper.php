...
namespace BlackCat\Database\Packages\RbacRepoSnapshots\Mapper;

use BlackCat\Database\Packages\RbacRepoSnapshots\Dto\RbacRepoSnapshotDto;
use BlackCat\Database\Packages\RbacRepoSnapshots\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacRepoSnapshotDto:
...
final class RbacRepoSnapshotDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'repo_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'metadata' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'taken_at' ];
    /** @var string[] */
     ...
     * @return RbacRepoSnapshotDto
     */
    public static function fromRow(array $row): RbacRepoSnapshotDto
    {
        /** @var RbacRepoSnapshotDto */
        return DtoHydrator::fromRow(
            RbacRepoSnapshotDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RbacRepoSnapshotDto
    {
     ...
     *
     * @param RbacRepoSnapshotDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacRepoSnapshotDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacRepoSnapshotDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacRepoSnapshotDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacRepoSnapshotDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacRepoSnapshotDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacRepoSnapshotDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacRepoSnapshotDto>
     */
