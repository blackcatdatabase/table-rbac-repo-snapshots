...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_repo_snapshots'; }
    public static function contractView(): string { return 'vw_rbac_repo_snapshots'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'repo_id', 'commit_id', 'taken_at', 'metadata' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'repo_id', 'commit_id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'repo_id' ]; }
