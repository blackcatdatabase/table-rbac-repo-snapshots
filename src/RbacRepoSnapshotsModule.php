...
final class RbacRepoSnapshotsModule implements ModuleInterface
{
    public function name(): string { return 'table-rbac_repo_snapshots'; }
    public function table(): string { return 'rbac_repo_snapshots'; }
