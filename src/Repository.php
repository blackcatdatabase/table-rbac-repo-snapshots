...
use BlackCat\Database\Packages\RbacRepoSnapshots\Repository\RbacRepoSnapshotRepository;
...
{
    private RbacRepoSnapshotRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RbacRepoSnapshotRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepoSnapshots\Dto\RbacRepoSnapshotDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RbacRepoSnapshots\Dto\RbacRepoSnapshotDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepoSnapshots\Dto\RbacRepoSnapshotDto|null
    {
