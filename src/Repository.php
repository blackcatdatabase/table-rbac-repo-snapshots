...
namespace BlackCat\Database\Packages\RbacRepoSnapshots;
...
use BlackCat\Database\Packages\RbacRepoSnapshots\Repository\RbacRepoSnapshotRepository as GeneratedRepository;
...
{
  private RbacRepoSnapshotRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacRepoSnapshotRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacRepoSnapshotRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepoSnapshots\Dto\RbacRepoSnapshotDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRepoSnapshots\Dto\RbacRepoSnapshotDto|null { return $this->repo->getById($id, $asDto); }
